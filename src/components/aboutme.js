        ...
        <Grid className="landing-grid mdl-grid--no-spacing">
          <Cell col={12}>
              ...
              Through my work, I have gained insights on how to thrive in team environments, what my learning styles are, and how to stay motivated in this line of work.</p>
                        <p style={{ color: 'black' }}>My passion for learning runs deep and is also exemplified by my own major: being in a combined major of
                        ...
                        <p style={{ color: 'black' }} id="bottom_p">Working in team settings, I have fostered my ability to promote success through collaboration,
            ...
            <div className="banner-text">
                        <h2 style={{ color: 'black' }}>Critic Reviews</h2>
                <Fade left cascade duration={1000} delay={500}>
                  <div class="stars">
                    ...
                    <span class="star half"></span>
                        ...
                        <p style={{ color: 'black' }}>"Joshua works very hard.
              ...
              The volume of work produced along with speed, accuracy has exceeded expectations."<p style={{ color: 'black' }}>  -  A Previous Employer</p></p>
              <br></br>
              <Fade left cascade duration={1000} delay={500}>
                <div class="stars">
                  <span class="star on"></span>
                  ...
                  <span class="star before"></span>
                        ...
                        <p style={{ color: 'black' }}>"A heart felt protagonist. Must see."<p style={{ color: 'black' }}>  -  The Times</p></p>
              <br></br>
              <Fade left cascade duration={1000} delay={500}>
                <div class="stars">
                  <span class="star on"></span>
                  ...
                  <span class="star on"></span>
                        ...
                        <p style={{ color: 'black' }}>"Shockingly hard working."<p style={{color:'black'}}>  -  The Guardian</p></p>
              <br></br>
